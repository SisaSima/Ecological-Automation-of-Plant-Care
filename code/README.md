...
There are two versions of the code: "code.py" and "code_no_LA.py":
...
"code_no_LA.py" uses a simple machine learning model that learns how long to water the plant so that its final soil moisture value is the same as a pre-defined desired value - "chcena_val"
